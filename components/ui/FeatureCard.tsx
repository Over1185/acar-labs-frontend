...
export default function FeatureCard({ icon, title, description }: FeatureCardProps) {
    return (
        <div className="group bg-white rounded-2xl p-6 border border-[var(--border-color)] hover:border-[var(--brand-deep-blue)] transition-all duration-300 hover:shadow-xl hover:shadow-[var(--brand-deep-blue)]/5">
            {/* Icon */}
            <div className="w-14 h-14 rounded-2xl bg-linear-to-br from-[var(--brand-deep-blue)]/10 to-[var(--brand-slate-blue)]/10 flex items-center justify-center mb-5 group-hover:from-[var(--brand-deep-blue)] group-hover:to-[var(--brand-slate-blue)] transition-all duration-300">
