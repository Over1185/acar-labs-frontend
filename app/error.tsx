    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-[70vh] px-4 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
                ...
                >
                    <svg fill="none" stroke="currentColor" className="w-5 h-5" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M4 4v5h.051m16.367 0c-.655 4.79-4.738 8-9.47 8-5.462 0-9.916-4.522-9.916-10 0-5.48 4.453-10 9.89-10q1.03.002 2.016.202l1.69 1.689" strokeWidth={2}/></svg>
                    Intentar de nuevo
                </button>
