        ...
        return (
            <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50/30">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                    <Link
                        href="/clinicas"
                        className="inline-flex items-center gap-2 mb-8 text-[#003366] hover:underline"
                    >
                    ...
                    <div className="bg-red-50 border border-red-200 rounded-2xl p-6 text-center">
                        ...
                        <p className="text-red-600">{error || 'No se encontró la clínica'}</p>
                    </div>
                </div>
            </div>
        );
                ...
                <div className="bg-white rounded-2xl shadow-lg p-8 mb-12">
                    ...
                    {clinic.address && (
                        <div className="flex items-start gap-4">
                            <svg className="w-6 h-6 text-[#003366] flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="mb-8 space-y-4">
                        <div className="relative">
                            <input
                                ...
                                className="w-full px-6 py-3 pl-12 rounded-full border border-gray-300 bg-white text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#003366]"
                            />
                            <svg
